...
const handleSave = () =>{
  ...
  return (
    // w-[35vw]
    <div
      className={` ${vreeStore.rightSideVisibility? "w-[35vw] mt-[2vh] h-[82vh] border border-gray-600 rounded-lg ms-8" :"hidden"}`}
      style={{
    ...
    >
      ...
      <div className="flex justify-between w-full text-lg font-bold cursor-pointer border-b-1 border-[#A673FF] gap-4 mt-2 ">
        ...
        <div
          ...
          className={` px-4 py-2 bg-transparent flex text-gray-400 rounded-md  hover:scale-115   transition duration-300 ${vreeStore.isDarkMode ? "text-gray-100 hover:text-white" : "text-gray-900"}`} 
        >
